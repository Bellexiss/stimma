...
<div class="info-page-content cooperation-page">
	...
	Співпраця з оптовиками </h1>
	<div class="info-page-menu">
 <a href="<?=$ru?>/cpivrobitnictvo/perevagi-spivpraci-z-kompaniyeyu-stimma/" class="info-page-menu-item"> Переваги співпраці </a> <a href="<?=$ru?>/cpivrobitnictvo/spivpracya-z-optovikami/" class="info-page-menu-item active"> Для оптових клієнтів </a> <a href="<?=$ru?>/cpivrobitnictvo/rozdribnim-kliyentam/" class="info-page-menu-item"> Для роздрібних клієнтів </a>
	</div>
 ...
 <b>
				...
				<ul>
					<li>
					надання офіційних документів (при необхідності); </li>
					<li>
 ...
 <b>
				...
				<ul>
					<li>
					обов’язкова націнка, не нижче роздрібної вартості на нашому сайті; </li>
					<li>
 ...
 <label for="input_NAME"><span>Прізвище Ім’я По батькові&nbsp;<span class="star">*</span></span></label> <input size="30" type="text" id="input_NAME" name="REGISTER[NAME]" required="" value="" aria-required="true" class="form-control">
						</div>
						<div class="form-block">
 <label for="input_EMAIL"><span>Логін / E-mail&nbsp;<span class="star">*</span></span></label> <input size="30" type="email" id="input_EMAIL" name="REGISTER[EMAIL]" required="" value="" aria-required="true" class="form-control">
						</div>
						<div class="form-block">
 ...
 <label for="input_PASSWORD"><span>Пароль&nbsp;<span class="star">*</span></span></label> <input size="30" type="password" id="input_PASSWORD" name="REGISTER[PASSWORD]" required="" value="" autocomplete="off" class="password form-control" aria-required="true">
						...
						<div class="form-block">
 <label for="input_CONFIRM_PASSWORD"><span>Підтвердження паролю&nbsp;<span class="star">*</span></span></label> <input size="30" type="password" id="input_CONFIRM_PASSWORD" name="REGISTER[CONFIRM_PASSWORD]" required="" value="" autocomplete="off" class="confirm_password form-control" aria-required="true">
						</div>
					</div>

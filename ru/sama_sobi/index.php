            ...
            <div class="info-page-banner-content">
                ...
                <div class="info-page-banner-title-block">
                    ...
                    <div class="info-page-banner-semititle">
                        Персональные скидки, уникальный доступ к эксклюзивным акциям, коллекциям и «Шкафу для своих» — открой все бенефиты!
                    </div>
                ...
                <div class="sama-sobi-block">
                    ...
                    <div class="sama-sobi-title-block">
                        <div class="sama-sobi-title">
                            Чем больше используешь STIMMA для шопинга, тем больше подарков получаешь
                        </div>
                    </div>
                    ...
                    <div class="sama-sobi-tutorial-list">
                        ...
                        <div class="sama-sobi-tutorial-item">
                            ...
                            <div class="sama-sobi-tutorial-text-block">
                                ...
                                <div class="sama-sobi-tutorial-item-title">
                                    САМА СЕБЕ STIMMA имеет 4 уровня: <br>
                                    Звезда, Дива, Икона Стиля и Богиня
                                </div>

                                <div class="sama-sobi-tutorial-text">
                                    Каждый из них открывает особые привилегии и предложения. <br>
                                    Для участия достаточно приобрести хотя бы одну вещь и зарегистрироваться
                                </div>
                        ...
                        <div class="sama-sobi-tutorial-item">
                            ...
                            <div class="sama-sobi-tutorial-text-block">
                                ...
                                <div class="sama-sobi-tutorial-item-title">
                                    Накапливай стимзы легко, трать приятно: <br>
                                    1 потраченная гривна = 1 начисленный стимз
                                </div>

                                <div class="sama-sobi-tutorial-text">
                                    За каждую приобретённую вещь ты будешь получать стимзы
                                </div>
                        ...
                        <div class="sama-sobi-tutorial-item">
                            ...
                            <div class="sama-sobi-tutorial-text-block">
                                ...
                                <div class="sama-sobi-tutorial-item-title">
                                    Получай стимзы за различные активности: <br>
                                    Отзывы, подписки, публикации и т.д.
                                </div>

                                <div class="sama-sobi-tutorial-text">
                                    За стимзы ты можешь получать вещи из «Шкафа для своих»: <br>
                                    одежду, аксессуары и товары для дома от STIMMA и брендов-партнёров
                                </div>
            ...
            <div class="wrapper">
                <div class="sama-sobi-block">
                                        ...
                                        <div class="sama-sobi-loyalty-list">
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Возможность накапливать и тратить стимзы
                                                </div>
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Уникальный доступ к ограниченным по времени акциям
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Бесплатная доставка заказа от 1500 грн
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Уникальный доступ к эксклюзивным коллаборациям
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Уникальный доступ к лимитированным коллекциям
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Скидки или сертификаты на услуги стилиста
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Приглашения на закрытые fashion-ивенты
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                ...
                                <div class="sama-sobi-loyalty-item">
                                    ...
                                    <div class="sama-sobi-loyalty-info">
                                        ...
                                        <div class="sama-sobi-loyalty-list">
                                            ...
                                            <div class="sama-sobi-loyalty-list-item">
                                                <div class="sama-sobi-loyalty-key">
                                                    Приглашения на закрытые фэшн-ивенты
                                                </div>
                                                <div class="sama-sobi-loyalty-value">
                                                    <span class="icon">
                                                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="sama-sobi-loyalty-ps">
                        *Начисления действительны в течение года с момента первой покупки<br>
                        ** Скидка ко Дню рождения действует за 5 дней до и 5 дней после твоего праздника
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="sama-sobi-section">
            <div class="wrapper">
                <div class="sama-sobi-block">
                    ...
                    <div class="sama-sobi-title-block">
                        <div class="sama-sobi-title">
                            За что вы накапливаете стимзы и на что их тратить
                        </div>
                    </div>
                    ...
                    <div class="sama-sobi-accum-cont">
                        ...
                        <div class="sama-sobi-accum-item">
                            ...
                            <div class="sama-sobi-accum-text">
                                Публикуй образы в своих <br> соцсетях
                            </div>
                        </div>
                        ...
                        <div class="sama-sobi-accum-item">
                            ...
                            <div class="sama-sobi-accum-text">
                                Приглашай подруг в Сама <br> Собі STIMMA
                            </div>
                        </div>
                ...
                <div class="sama-sobi-block">
                    ...
                    <div class="sama-sobi-icon-block">
                        ...
                        <div class="sama-sobi-icon-item">
                            ...
                            <div class="sama-sobi-icon-text-block">
                                <div class="sama-sobi-icon-title">
                                    Безусловная любовь и безупречный стиль
                                </div>
                                <div class="sama-sobi-icon-text">
                                    потому что ты достойна всего «самого-самого»
                                </div>
                            </div>
                        </div>
                        <div class="sama-sobi-icon-item">
                            ...
                            <div class="sama-sobi-icon-text-block">
                                ...
                                <div class="sama-sobi-icon-text">
                                    чтобы собрать ещё больше стимзов
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="discount-block">
                        ...
                        <div class="discount-text-block">
                            <div class="discount-text-title">
                                Присоединяйся, чтобы как можно быстрее узнавать о новых поступлениях и акциях
                            </div>
                            <div class="discount-text">
                                ** Скидка действует один раз и только на новинки (товары с чёрными ценниками). Промокод не суммируется с другими акциями <br> и может не распространяться на некоторые товары. Подробности по ссылке
                            </div>
                        </div>
                        <form>

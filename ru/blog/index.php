...
<?
if($APPLICATION->GetCurPage() == '/ru/blog/')
{
...
*/?>
<?
if($APPLICATION->GetCurPage() == '/ru/blog/blagodiyna-initsiativa-vid-tabletochki-ta-stimma/')
{
    $APPLICATION->SetPageProperty('title','Благотворительная инициатива от Tabletochki и Stimma');
    $APPLICATION->SetPageProperty('description','Stimma объединили силы с благотворительным фондом Таблеточки, чтобы помочь детям, которые борются с онкологическими заболеваниями.');
}
if($APPLICATION->GetCurPage() == '/ru/blog/nezalezhni-33-manifest-stimma/')
{
    $APPLICATION->SetPageProperty('title','Независимые 33: Манифест STIMMA');
    $APPLICATION->SetPageProperty('description','По случаю 33-й годовщины Независимости Украины бренд одежды STIMMA представляет проект «Независимые 33», посвященный силе и уверенности украинских женщин');
}
if($APPLICATION->GetCurPage() == '/ru/blog/')
{
    $APPLICATION->SetPageProperty('title','О нас пишут');
    $APPLICATION->SetPageProperty('description','Интернет-магазин “Стима” в СМИ');
}
?>

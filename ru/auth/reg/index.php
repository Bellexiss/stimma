        ...
        <div class="wrapper">
	        ...
	        <div class="auth-page">
	        	...
	        	<div class="auth-reg-text">
                    Зарегистрируйтесь, что бы использовать все возможности личного кабинета: отслеживания заказов, настройки подписки, связи с социальными сетями и другое. Мы никогда и ни при каких обстоятельствах не разглашаем личные данные клиентов. Контактная информация будет использована только для оформления заказов та более удобной работы с сайтом.
	        	</div>
	        				...
	        				<div class="auth-inputs">
	        					<div class="auth-inputs-group">
	        						<div class="form-block">
	                                    <input size="30" type="text" name="" value="" class="form-control" placeholder="Ваше Имя">
	                                </div>
	                                <div class="form-block">
	                                	<input size="30" type="text" name="" value="" class="form-control" placeholder="Фамилия">
	                                </div>
	        					</div>
	        					<div class="auth-inputs-group">
	        						<div class="form-block">
	        					...
	        					<div class="licence_block filter label_block">
	                                ...
	                                <label for="oferta_agree">
	                                    Я погоджуюсь з договором оферти і політикую конфіденційности
	                                </label>
	                            </div>

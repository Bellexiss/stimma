...
$APPLICATION->SetPageProperty("description", "Купить Распродажа. ⭐ Цена от 129 грн. ⚡ Быстрая доставка по Украине ⭐ ТМ «Стимма» – модная женская одежда.");
$APPLICATION->SetPageProperty("title", "Распродажа от 129 грн. Купить Распродажа от ТМ «Стимма» | Харьков, Киев, Днепр, Одесса, Львов");
?>
...
if($APPLICATION -> GetCurPage() == '/catalog/novinki/' || $APPLICATION -> GetCurPage() == '/ru/catalog/novinki/')
{
    ...
    while ($record = $res -> GetNextElement())
    {
        ...
        $files[] = [
            'UF_FILE' => $userPhoto = CFile::ResizeImageGet($props['UF_FILE']['VALUE'], array('width'=>2000, 'height'=>2000), BX_RESIZE_IMAGE_PROPORTIONAL, true)['src'],
...
$isSmartOffice=false;
if($APPLICATION -> GetCurPage() == '/catalog/snart_office/' || $APPLICATION -> GetCurPage() == '/ru/catalog/snart_office/')
{
    $isSmartOffice=true;
...

{
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "ELEMENT_SORT_FIELD" => isset($_GET['by']) ? ['by'] : "id",
            "ELEMENT_SORT_ORDER" => isset($_GET['sort']) ? ['sort'] : "desc",

...
if(!$USER->isAuthorized()){
	...
	if($APPLICATION->GetCurPage() == '/ru/personal/orders/')
	{
		global $DB;
	...
	array(
		...
		"PATH_TO_BASKET" => "/ru/basket/",
		"PATH_TO_CATALOG" => "/ru/catalog/",
		"PATH_TO_CONTACT" => "/ru/contacts",
		"PATH_TO_PAYMENT" => "/ru/order/payment/",
		"PER_PAGE" => "20",
		"PROP_1" => array(
		),
		"PROP_2" => array(

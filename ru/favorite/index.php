...
$APPLICATION->SetTitle("Твой вишлист");
...
?>
    ...
    <div class="personal-page">
        <div class="wrapper">
            <div class="personal-cont no-aside">
                ...
                <div class="personal-content">
                    ...
                    <div class="personal-content-block">
                        <div class="personal-content-title-block">
                            <h1 class="personal-content-title">
                        ...
                        if(empty($favorite['ID']))
                        {
                            ...
                            <div class="personal-wish-list-empty">
                                <div class="personal-wish-list-empty-text">
                                    <p>Твой вишлист пуст</p>
                                    <p class="uppercase">ДОБАВАЙ НЕОГРАНИЧЕНИЕ КОЛЬКОСТЬ CBOIX БAЖAHOK, ПЛАГУЙ ОБРАЗЫ И ОБЫРАЙ CEPЦEM!</p>
                                </div>
...
<?
$APPLICATION->SetPageProperty('title',"Твой вишлист | Магазин женской одежды STIMMA");
$APPLICATION->SetPageProperty(
    'description',
    "Твой вишлист STIMMA ⭐️ Базовые и трендовые вещи для современного гардероба ✔️ Актуальные коллекции, продуманные силуэты и комфорт на каждый день ✈️ Заказывайте онлайн с доставкой по всей Украине"
);

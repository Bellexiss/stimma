...
$APPLICATION->SetPageProperty("description", "Модная женская одежда от украинского производителя TM STIMMA. Избранные товары");
$APPLICATION->SetPageProperty("title", "Избранные товары | Интернет-магазин STIMMA");

...
$APPLICATION->SetTitle("Твій вішліст | Магазин жіночого одягу STIMMA");
...
<?
$APPLICATION->SetPageProperty('title',"Твій вішліст | Магазин жіночого одягу STIMMA");
$APPLICATION->SetPageProperty('description',"Твій вішліст STIMMA ⭐️ Базові та трендові речі для сучасного гардероба ✔️ Актуальні колекції, продумані силуети та комфорт щодня ✈️ Замовляйте онлайн з доставкою по Україні");

...
$APPLICATION->SetPageProperty("description", "Модний жіночий одяг від українського виробника ТМ STIMMA. Вибрані товари");
$APPLICATION->SetPageProperty("title", "Вибрані товари | Інтернет-магазин STIMMA");

$APPLICATION->SetTitle("Вибрані товари");
global $favorite;

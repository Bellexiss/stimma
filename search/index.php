    ...
    <div class="search-page">
        <div class="wrapper">
            <div class="search-cont">
                ...
                {
                    $_SESSION['SERACH_WORDS'] = addslashes(trim($_GET['q']));
                }

                $search = $_SESSION['SERACH_WORDS'] ?? '';
                $ids = [];

                $res = $DB -> Query('select ID from b_iblock_element where ACTIVE = \'Y\' and LOWER(NAME) like \'%'.strtolower($search).'%\'');
                //$res = $DB -> Query('select ID from b_iblock_element where ACTIVE = \'Y\' and SOUNDEX(NAME) = SOUNDEX(\''.$search.'\')');
                while ($record = $res -> Fetch())
                    $ids[$record['ID']] = $record['ID'];

                $res = CIBlockElement::GetList([], ['IBLOCK_ID' => 21, '%PROPERTY_NAME_UA' => $search,'ACTIVE' => 'Y']);
                while ($record = $res -> Fetch())
                    $ids[$record['ID']] = $record['ID'];

                ?>
                <div class="seacrh-input-cont">
                    <form class="seacrh-input-block-cont">
                        <div class="seacrh-input-block">
                            <input type="text" name="q" value="<?=$search?>" placeholder="<?=LANGUAGE_ID=='ua'?'Що шукаєте? Сукня, жакет...':'Что ищете? Юбка, жакет...'?>">
                            <button class="seacrh-input-clear">
                                <svg width="17" height="17" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="1" y1="1" x2="16" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                    <line x1="16" y1="1" x2="1" y2="16" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                                </svg>
                            </button>
                        </div>
                        <div class="seacrh-input-btn-block">
                            <button type="submit" class="seacrh-input-btn-icon"><?/*=LANGUAGE_ID=='ua'?'Знайти':'Найти'*/?>
                ...
                <?
                $search = Option::get('main', "search_settings", "");
                $search = unserialize($search);
                ?>
                <div class="search-popular-block">
                    <div class="search-popular-title">
                        Найчастіше шукають:
                    </div>
                    <div class="search-popular-list">
                        <?
                        foreach($search['ua'] as $index => $sItem)
                        {
                            ?>
                            <a href="<?=$ru?>/search/?q=<?=$sItem['phrase']?>" class="search-popular-item">
                                <?=$sItem['word']?>
                            </a>
                            <?
                        }
                        ?>
                        <?/*
                        <a href="<?=$ru?>/search/?q=<?=LANGUAGE_ID=='ua'?'Сукня':'Юбка'?>" class="search-popular-item">
                            Cукні
                        </a>
                        <a href="<?=$ru?>/search/?q=<?=LANGUAGE_ID=='ua'?'Сорочка':'Сорочка'?>" class="search-popular-item">
                            Сорочки
                        </a>
                        <a href="<?=$ru?>/search/?q=<?=LANGUAGE_ID=='ua'?'Жакет':'Жакет'?>" class="search-popular-item">
                            Жакети
                        </a>
                        <a href="<?=$ru?>/search/?q=<?=LANGUAGE_ID=='ua'?'Куртка':'Куртка'?>" class="search-popular-item">
                            Верхній одяг
                        </a>
                        <a href="<?=$ru?>/search/?q=<?=LANGUAGE_ID=='ua'?'Штани':'Штаны'?>" class="search-popular-item">
                            Штани
                        </a>
                        */?>
                    </div>
                ...
                ?>
                <div class="search-goods-ex-cont" style="margin-top: 25px;">
                    <div class="search-goods-ex-title">
                        <?=LANGUAGE_ID=='ua'?'Вас може це зацікавити:':'Вас может заинтересовать:'?>
                    </div>
                    <div class="search-goods-ex-slider-cont">
                        ...
                        $params['WRAP_CLASS']= 'search-goods-ex-slider';
    	...
    	<div class="search-page">
    		<div class="wrapper">
    			<div class="search-cont">
    				...
    				<div class="seacrh-input-cont">
    					<div class="seacrh-input-block">
    						<input type="text" name="<?=$_GET['q']?>" placeholder="<?=LANGUAGE_ID=='ua'?'Пошук':'Поиск'?>">
    						<button class="seacrh-input-clear">
    							<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8.02637 7.18164L15.207 0.00195312L16.0518 0.84668L8.87109 8.02637L16.0518 15.207L15.207 16.0518L8.02637 8.87109L0.844727 16.0537L0 15.209L7.18164 8.02637L0 0.844727L0.844727 0L8.02637 7.18164Z" fill="currentcolor"/>
								</svg>
    						</button>
    					</div>
    					<div class="seacrh-input-error">Не знайдено результатів для “вівів”. Перевірте правопис або знайдіть натхнення серед наших рекомендацій</div>
    				</div>
    				<div class="search-popular-block">
    					<div class="search-popular-title">
    						Найчастіше шукають:
    					...
    					<div class="search-popular-list">
    						<a href="<?=$ru?>/search/?q=Cукні" class="search-popular-item">
    							Cукні
    						</a>
    						<a href="<?=$ru?>/search/?q=Сорочки" class="search-popular-item">
    							Сорочки
    						</a>
    						<a href="<?=$ru?>/search/?q=Жакети" class="search-popular-item">
    							Жакети
    						</a>
    						<a href="<?=$ru?>/search/?q=Верхній одяг" class="search-popular-item">
    							Верхній одяг
    						</a>
    						<a href="<?=$ru?>/search/?q=Штани" class="search-popular-item">
    							Штани
    						</a>
    					</div>
    				</div>
                    */?>
    				...
    				<div class="search-goods-ex-cont">
    					<div class="search-goods-ex-title">
    						<?=LANGUAGE_ID=='ua'?'Вас може це зацікавити:':'Вас может заинтересовать:'?>
    					</div>
    					<div class="search-goods-ex-slider-cont">
                            ...
                            ?>
                            <?/*
    						<div class="search-goods-ex-slider"> <!-- WRAP_CLASS -->
	                            <div class="search-goods-ex-slider-item"> <!-- BLOCK_CLASS -->
	                            ...
	                            <div class="search-goods-ex-slider-item">
	                                <div class="catalog-item">
	                                    <div class="catalog-item-top">
	                                        <div class="catalog-item-img">
	                                            <a href="#">

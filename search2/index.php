                    ...
                    if(!empty($ids))
                    {
                        ...
                        <div class="search-popular-block">
                            ...
                            <div class="search-popular-list">
                                <a href="<?=$ru?>/search2/?q=<?=LANGUAGE_ID=='ua'?'Сукня':'Юбка'?>" class="search-popular-item">
                                    Cукні
                                </a>
                                <a href="<?=$ru?>/search2/?q=<?=LANGUAGE_ID=='ua'?'Сорочка':'Сорочка'?>" class="search-popular-item">
                                    Сорочки
                                </a>
                                <a href="<?=$ru?>/search2/?q=<?=LANGUAGE_ID=='ua'?'Жакет':'Жакет'?>" class="search-popular-item">
                                    Жакети
                                </a>
                                <a href="<?=$ru?>/search2/?q=<?=LANGUAGE_ID=='ua'?'Куртка':'Куртка'?>" class="search-popular-item">
                                    Верхній одяг
                                </a>
                                <a href="<?=$ru?>/search2/?q=<?=LANGUAGE_ID=='ua'?'Штани':'Штаны'?>" class="search-popular-item">
                                    Штани
                                </a>
                            </div>
                        </div>

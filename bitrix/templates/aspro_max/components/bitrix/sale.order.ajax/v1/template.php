...
?><script>window.use_coupon = 1;</script><?
    ...
    <form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row orderform--v1 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-9 bx-soa">
                ...
                <!--	BUYER SERTIFICATE BLOCK	-->
                <?
                if(isset($_GET['me']))
                {
                    ?>
                    <div id="" data-visited="true" class="bx-soa-section bx-active bx-step-completed">
                        <div class=" bx-soa-section-title-container">
                            <h2 class="bx-soa-section-title col-sm-9 no-icon">
                                <span class="bx-soa-section-title-count"></span>Код сертифікату
                            </h2>
                        </div>
                        <div class="bx-soa-section-content">
                            <div class="">
                                <div class="bx-soa-coupon-block">
                                    <div class="">
                                        <?/*<input type="checkbox" name="im_receiver"> <?=LANGUAGE_ID == 'ua' ? 'Прислати код відразу після оплати' : ''?>*/?>
                                        <input class="form-control bx-ios-fix" id="sertnphone" type="tel" placeholder="Номер телефону" name="sertificate_phone_fake">
                                        <input type="hidden" name="sertificate_phone">
                                    </div>
                                    <div class="">
                                        <input class="form-control bx-ios-fix" id="sertdate" type="text" placeholder="Дата" name="sertificate_date">
                                    </div>
                                </div>
                            </div>
                        </div>

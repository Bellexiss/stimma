...
<?global $arTheme, $arRegion;?>
		...
		<?$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"INCLUDE_IBLOCK_INTO_CHAIN" => LANGUAGE_ID == 'ua' ? 'N' : $arParams["INCLUDE_IBLOCK_INTO_CHAIN"],
				"ADD_SECTIONS_CHAIN" => LANGUAGE_ID == 'ua' ? 'N' : $arParams["ADD_SECTIONS_CHAIN"],
				"ADD_ELEMENT_CHAIN" => LANGUAGE_ID == 'ua' ? 'N' : $arParams["ADD_ELEMENT_CHAIN"],

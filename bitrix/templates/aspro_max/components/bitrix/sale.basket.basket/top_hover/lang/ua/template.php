<?
	...
	$MESS["CLEAR_BASKET"] = "Скинути корзину";
	...
	$MESS["SALE_NO_ITEMS"] = "В вашей корзине ещё нет товарів.";
	...
	$MESS["SALE_BACK_DESCRIPTION"] = "Вернуться к выбору товарів";
	$MESS["SALE_ORDER"] = "Оформить заказ";
	$MESS["SALE_TO_BASKET_DESCRIPTION"] = "Полноценное оформление<br/> заказа";
	$MESS["SALE_ORDER_DESCRIPTION"] = "";
	$MESS["SALE_FAST_ORDER"] = "Швидке замовлення";
	...
	$MESS["USER_AUTH"] = "Вхід\реєстрація";
	$MESS["COMPARE_BLOCK"] = "Сравнение товарів";

	$MESS["EMPTY_BLOCK_BASKET"] = "Корзина пуста";
	$MESS["EMPTY_BLOCK_DELAY"] = "Список отложенных товарів пуст";

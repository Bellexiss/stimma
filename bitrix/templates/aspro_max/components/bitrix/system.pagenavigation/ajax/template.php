...
<?if($arResult["NavPageCount"] > 1):?>
	...
	<div class="module-pagination ajax">
		<div class="nums">
			<ul class="flex-direction-nav fdn5">
				<?if(!$bPrevDisabled):?>
			...
			<?while($arResult["nStartPage"] <= $arResult["nEndPage"]):?>
				...
				<?elseif($arResult["nStartPage"] == 1 && $arResult["bSavePage"] == false):?>
					<a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>" class="dark_link dl3"><?=$arResult["nStartPage"]?></a>
				<?else:?>
					<a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>" class="dark_link dl4"><?=$arResult["nStartPage"]?></a>
				<?endif;?>
				<?$arResult["nStartPage"]++;?>
			<?endwhile;?>

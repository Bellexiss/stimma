...
if($arSections){
	...
	foreach($arSections as $ID => $arSection){
        if(LANGUAGE_ID == 'ua')
        {
            if($arSection['UF_NAME_UA']) $arSections[$ID]['NAME'] = $arSection['UF_NAME_UA'];
        }

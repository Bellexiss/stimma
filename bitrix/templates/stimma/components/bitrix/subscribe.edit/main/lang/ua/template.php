...
$MESS ['adm_auth_exist'] = "Авторизація существующего пользователя";
...
$MESS ['subscr_auth_note'] = "Авторизація не является обязательной. Вы можете подписаться на рассылки, не регистрируясь на сайте.";

...
<?/*
    <div class="card-page-cont" style="display:none;">
        ...
        <div class="card-main-info">
            <div class="card-main-sliders">
                <div class="card-big-slider-cont">
                    ...
                    <div class="catalog-item-favorite" aria-label="<?=LANGUAGE_ID == 'ua' ? 'Додати в обране' : 'Добавить в избранное'?>">
                            ...
                            ?><div class="card-big-slider-item">
                                <div class="easyzoom easyzoom--overlay">
                                    <a href="<?=$item['ORIGINAL']?>">
                                        <img class="big_img_sert <?=$isSert ? 'is_sert' : ''?>" <?=!$index ? 'class="first_img"' : ''?> src="<?=convertToWebP($item['BIG'])?>" alt="<?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['NAME']?>, <?=$colorName?> - <?=$arResult['OFFERS'][0]['DISPLAY_PROPERTIES']['COLOR_REF']['DISPLAY_VALUE']?>">
                                    </a>
                                </div>
                            </div><?
                        }
                    ...
                    <div class="card-small-slider">
                        ...
                        foreach ($arResult['SLIDER'] as $index => $item)
                        {
                            ...
                            ?><div class="card-small-slider-item">
                                <img class="small_img_sert <?=!$index ? 'first_image' : ''?> <?=$isSert ? 'is_sert' : ''?>" src="<?=convertToWebP($item['SMALL'])?>" alt="<?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['NAME']?>, <?=$colorName?> - <?=$arResult['OFFERS'][0]['DISPLAY_PROPERTIES']['COLOR_REF']['DISPLAY_VALUE']?>">
                            </div><?
                        }
                        ?>
                    </div>
                ...
                <div class="card-info-bottom" data-entity="scu">
                    ...
                    if(strpos($APPLICATION->GetCurPage(), '/podarochnyy_sertifikat/') === false)
                    {
                        ...
                        <div class="card-info-color-cont" data-code="COLOR_REF">
                            ...
                            <a href="#" class="card-info-size-btn" data-toggle="modal" data-target="#size-popup">
						<span class="icon">
...
?>
    ...
    <div class="new-card-page">
        <div class="new-card-img-cont">
                ...
                <div class="new-card-small-cont">
                    <div class="new-card-small-list">
                        ...
                        foreach ($arResult['SLIDER'] as $index => $item)
                        {
                            $colorName = LANGUAGE_ID == 'ua' ? 'колір' : 'цвет';
                            ?>
                            <a href="#imgn<?=$index?>" class="new-card-small-img active" aria-label="<?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['NAME']?>">
                                <img class="<?=$isSert ? 'is_sert' : ''?>" src="<?=convertToWebP($item['SMALL'])?>" alt="<?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['NAME']?>, фото <?=$indexSlider?><?/*=$colorName?> - <?=$arResult['OFFERS'][0]['DISPLAY_PROPERTIES']['COLOR_REF']['DISPLAY_VALUE']*/?>">
                            </a>
                            <?
                            $indexSlider++;
                            if($bIndex) break;
            ...
            <div class="new-card-big-cont" <?=$arParams['B_INDEX'] ? 'style="min-width: 100%;min-height: 100%;"' : ''?>>
                <?
                $indexSlider = 1;
                foreach ($arResult['SLIDER'] as $index => $item)
                {
                    $colorName = LANGUAGE_ID == 'ua' ? 'колір' : 'цвет';
                    ?>
                    <div class="new-card-big-img " id="imgn<?=$index?>">
                        <img class="big_img_sert" src="<?=convertToWebP($item['BIG'])?>" alt="<?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['NAME']?>, фото <?=$indexSlider?> <?/*=$colorName?> - <?=$arResult['OFFERS'][0]['DISPLAY_PROPERTIES']['COLOR_REF']['DISPLAY_VALUE']*/?>">
                    </div>
                    <?
                    if($bIndex) break;
                }
            ...
            <div class="new-card-info-cont">
                <div class="new-card-info-block" data-entity="scu" style="height: 100%;">
                        ...
                        <div class="breadcrumbs swipeignore" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            <div class="breadcrumbs__item" id="bx_breadcrumb_0" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                <a class="breadcrumbs__link" href="/" title="Головна" itemprop="item">
                                    <span itemprop="name" class="breadcrumbs__item-name font_xs">Головна</span>
                                    <meta itemprop="position" content="1">
                                </a>
                            </div>
                            <span class="breadcrumbs__separator">—</span>
                            <div class="breadcrumbs__item cat_last" id="bx_breadcrumb_1" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                <a class="breadcrumbs__link" href="/blog/" title="Проєкти" itemprop="item">
                            ...
                            while($record = $nav->Fetch())
                            {
                                ...
                                <span class="breadcrumbs__separator">—</span>
                                <div class="breadcrumbs__item cat_last" id="bx_breadcrumb_1" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                    <a class="breadcrumbs__link" href="<?=$url?>" title="Проєкти" itemprop="item">
                                        <span itemprop="name" class="breadcrumbs__item-name font_xs"><?=$name?></span>
                                        <meta itemprop="position" content="2">
                                    </a>
                                </div>
                                <?
                            ...
                            <span class="breadcrumbs__separator">—</span>
                            <div class="breadcrumbs__item cat_last" id="bx_breadcrumb_1" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                                <span class="breadcrumbs__link" href="" title="Проєкти" itemprop="item">
                                    <span itemprop="name" class="breadcrumbs__item-name font_xs"><?=$name?></span>
                                    <meta itemprop="position" content="2">
                                </span>
                            </div>
                    ...
                    <div class="new-card-info-goods">
                        <div class="new-card-info-name h1five" data-entity="name_card">
                            <h1 style="font-size:20px" class="h1one">
                                <?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] . ' ' . $arResult['COLORS_FOR_CHANGE'][$arResult['PROPERTIES']['COLOR_REF']['VALUE']] . $ccName : $arResult['NAME'] . ' ' . $arResult['COLORS_FOR_CHANGE'][$arResult['PROPERTIES']['COLOR_REF']['VALUE']] .$ccName?>
                            </h1>
                        </div>
                        <div class="new-card-info-price-block <?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['PRICES']['BASE']['DISCOUNT_VALUE'] > $arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE'] ? 'new-card-info-price-discount' : ''?>">
                            <? if ($arResult['PROPERTIES']['PROP_BONUS']['VALUE']): ?>
                                <div class="new-card-info-price"><?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE']?> <?= UA ? "стімзів" : "стимзов" ?> </div>
                            <? else: ?>
...
<? //endif; ?>
                    ...
                    <div class="new-card-size-block">
						<?php
						//if (strpos($_SERVER['REQUEST_URI'], 'catalog/bonusna_shafa') == false)
                        {
						?>
                        <div class="new-card-size-list" data-entity="scu-values" data-code="RAZMER">
                            ...
                            foreach ($sizes as $indexOFfer => $value)
                            {
                                ?><div class="new-card-size-item <?=$isSert ? 'is_sert' : ''?> <?=$value['active'] ? 'active' : ''?>" data-entity="scu-value" data-id="<?=mb_strtolower($value['offer_id'])?>" data-img="<?=$value['imag']?>" data-img2="<?=$value['imag_2']?>" data-original="<?=$value['original']?>"><?=$value['value']?></div><?
                            }
                        ...
                        if(isset($_GET['p']))
                        {
                            ...
                            <div class="new-card-size-btn">
                                <a href="#" class="new-card-size-guide" data-toggle="modal" data-target="#modal-size">
                                    <?=UA?'Підбір розміру':'Подбор размера'?>
                                </a>
                            </div>
                            <?
                        }
						...
						//if (strpos($_SERVER['REQUEST_URI'], 'catalog/bonusna_shafa') == false)
                        {
                            ?><div class="catalog-item-colors cic2"><?
                            $nameColor = LANGUAGE_ID == 'ua' ? 'Колір' : 'Цвет';
                            foreach ($arResult['COLOR_VARIANTS'] as $colorXmlid => $colorLink)
                            {
                                ?>
                                <a style="background-color: <?=$arResult['ALL_COLORS'][$colorXmlid]?>;" aria-label="<?=$arResult['COLOR_LIST'][$colorXmlid]?> <?=$nameColor?>" href="<?=$colorLink?>" class="catalog-item-color <?=strtoupper($arResult['ALL_MAIN_COLORS'][$colorXmlid]) == '#FFFFFF' ? 'white' : ''?> <?=$colorXmlid == $arResult['PROPERTIES']['COLOR']['VALUE'] ? 'active' : ''?>" >
                                </a>
                                <?
                            }
                            ?></div><?
                    ...
                    <?
                    /*if($arResult['IBLOCK_SECTION_ID'] == 1250)
                    {
                    ...
                    else
                    {
                        ...
                        <div class="new-card-btn">
                            ...
                            >
                                <?=UA ? 'Додати до кошика у ₴' : 'Добавить в корзину у ₴'?>
                            </a>

                        </div>
                        <?
                        //if($arResult['IBLOCK_SECTION_ID'] == 1311 && false)
                        if(isset($_GET['s']))
                        {
                            ?>
                            <div class="new-card-btn">
                                <a href="#" class="new-card-btn-buy buy_product in_s"
                                   onclick="addToCartEK(<?=$arResult['ID']?>, '<?=addslashes($itemName)?>', <?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE']?>, '<?=addslashes($sectionName)?>', 1,'add_to_cart', true, 'Item View', 1,<?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE']?>);"
                                   data-id="<?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['ID']?>"
                                   style="background: #fff; color:#000"
                                >
                                    <?=UA ? 'Додати до кошика у S' : 'Добавить в корзину у S'?>
                                </a>
                            </div>
                            <?
                        }
                    ...
                    <div class="new-card-tabs">
                        <?/*<ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item active ">
                                <a class="nav-link" id="card-info1" data-toggle="tab" href="#card-infot1" role="tab" aria-selected="true">Опис</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="card-info2" data-toggle="tab" href="#card-infot2" role="tab" aria-selected="false"><?=UA ? 'Деталі' : 'Детали'?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="card-info3" data-toggle="tab" href="#card-infot3" role="tab" aria-selected="false"><?=UA ? 'Заміри' : 'Замеры'?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="card-info4" data-toggle="tab" href="#card-infot4" role="tab" aria-selected="false"><?=UA ? 'Доставка' : 'Доставка'?></a>
                            </li>
                        </ul>*/?>
                        <div class="tab-content svtmp22344" >
                            <div class="tab-pane fade active in" id="card-infot1" role="tabpanel" >
                                <div class="new-card-info-text">
                                    ...
                                    ?>
                                    <p style="margin-top: 15px;"><?=str_replace(array_keys($fromTo2), $fromTo2, $arResult['OFFERS'][0]['PROPERTIES']['PARAM_MODEL']['VALUE']);?></p>
                                    <?
                                    if($arResult['OFFERS'][0]['PROPERTIES']['RAZMERNOST_'.strtoupper(LANGUAGE_ID)]['VALUE'])
                                    {
                                        /*?><p><?=$arResult['PROPERTIES']['RAZMERNOST_'.LANGUAGE_ID]?></p><?*/
                    ...
                    <div class="new-card-size-block">
                        <div class="new-card-size-btn">
							...
							<?php
								...
								if ( UA && isset($arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_UA']) && trim($arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_UA']['VALUE']) != '' ) {
									?>
										<span href="#" class="new-card-size-guide new-card-size-guide-delivery" style="color: #8b0000;">
										<?= $arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_UA']['VALUE'] ?>
										</span><br>
									<?php
								}
								if ( !UA && isset($arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_RU']) && trim($arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_RU']['VALUE']) != '' ) {
									?>
										<span href="#" class="new-card-size-guide new-card-size-guide-delivery" style="color: #8b0000;">
										<?= $arResult['OFFERS'][0]['PROPERTIES']['WAITTIME_RU']['VALUE'] ?>
										</span><br>
									<?php
								}
								//echo "<pre>";print_R($arResult['OFFERS'][0]['PROPERTIES']);echo "</pre>";exit();
							
							?>
						
                            <a href="#" class="new-card-size-guide new-card-size-guide-delivery" style="color:black;">
                                <?=UA?'Доставка':'Доставка'?>
                            </a>
                        </div>
                    </div>    
                ...
                <?/*<div class="new-card-bottom-text">
                    <div class="new-card-bottom-left">Безкоштовна доставка при замовленні понад 3000 <span>грн</span></div>
                    <div class="new-card-bottom-right">
                        <a href="#" >Потрібна допомога?</a>
                    </div>
                </div>*/?>
            </div>
        </div>
        <div class="new-card-info-mob">
            <div class="new-card-info-name h1two">
                <?=LANGUAGE_ID == 'ua' ? $arResult['PROPERTIES']['NAME_UA']['VALUE'] . ' ' . $arResult['COLORS_FOR_CHANGE'][$arResult['PROPERTIES']['COLOR_REF']['VALUE']] . $ccName : $arResult['NAME'] . ' ' . $arResult['COLORS_FOR_CHANGE'][$arResult['PROPERTIES']['COLOR_REF']['VALUE']] .$ccName?><?//=LANGUAGE_ID == 'ua' && $arResult['OFFERS'][$selected]['PROPERTIES']['NAME_UA']['VALUE'] ? $arResult['OFFERS'][$selected]['PROPERTIES']['NAME_UA']['VALUE'] : $arResult['OFFERS'][$selected]['NAME'] ?>
            </div>
            ...
            <div class="new-card-btn">
                <a href="#" class="new-card-btn-buy triggeropenbasket" style="display:none;"
                   data-id="<?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['ID']?>"
                ><?=UA ? 'Перейти до кошику' : 'Перейти к корзине'?></a>
                <?
                if($arResult['SKIP_OFFERS'])
                {
                    ?>
                ...
                else
                {
                    ...
                    <a href="#" class="new-card-btn-buy buy_product"
                       onclick="addToCartEK(<?=$arResult['ID']?>, '<?=addslashes($itemName)?>', <?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE']?>, '<?=addslashes($sectionName)?>', 1,'add_to_cart', true, 'Item View', 1,<?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['MIN_PRICE']['DISCOUNT_VALUE']?>);"
                       data-id="<?=$arResult['OFFERS'][$arResult['SELECTED_OFFER']]['ID']?>"
                    ><?=UA ? 'Додати до кошика у ₴' : 'Добавить в корзину у ₴'?></a>
                    <?
                    //if($arResult['IBLOCK_SECTION_ID'] == 1311 && false)
                    if(isset($_GET['s']))
                    {
...
<?/*
    <div class="new-card-page">
        <div class="new-card-img-cont">
            <div class="new-card-small-cont">
                <div class="new-card-small-list">
                    <a href="#imgn1" class="new-card-small-img active">
                        <img src="/bitrix/templates/stimma/images/smallimg.avif">
                    </a>
                    <a href="#imgn2" class="new-card-small-img">
                        <img src="/bitrix/templates/stimma/images/smallimg.avif">
                    </a>
                    <a href="#imgn3" class="new-card-small-img">
                        <img src="/bitrix/templates/stimma/images/smallimg.avif">
                    </a>
                    <a href="#imgn4" class="new-card-small-img">
                        <img src="/bitrix/templates/stimma/images/smallimg.avif">
                    </a>
                    <a href="#imgn5" class="new-card-small-img">
                        <img src="/bitrix/templates/stimma/images/smallimg.avif">
                    </a>
                </div>
            </div>
        ...
        <div>
            <div class="new-card-info-cont">
                <div class="new-card-info-block">
                    <div class="new-card-info-goods">
                        <div class="new-card-info-name">
                            Cable knit corset in cream
                        </div>
                        <div class="new-card-info-price-block">
                            <div class="new-card-info-price-old">2000 грн</div>
                            <div class="new-card-info-price">1500 грн</div>
                        </div>
                    </div>
                    <div class="new-card-tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="card-info2" data-toggle="tab" href="#card-infot2" role="tab" aria-selected="false">Деталі</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="card-info3" data-toggle="tab" href="#card-infot3" role="tab" aria-selected="false">Розміри</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="card-info4" data-toggle="tab" href="#card-infot4" role="tab" aria-selected="false">Доставка</a>
                            </li>
                        </ul>
                        <div class="tab-content" >
                            <div class="tab-pane fade active in" id="card-infot1" role="tabpanel" >
                                <div class="new-card-info-text">
                                    Наш фірмовий укорочений топ-бюстьє-корсет із тросовою в’язкою та округлими чашечками з надм’якого екологічного кашеміру підходить для поєднання з брюками в тон.
                                </div>
                            </div>
                            <div class="tab-pane fade" id="card-infot2" role="tabpanel">
                                <div class="new-card-info-text">
                                    <p>ID: 103024</p>
                                    <p>Оболонка 100% Еко Кашемір</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="card-infot3" role="tabpanel">
                                <div class="new-card-info-text">
                                    <p>Ця деталь відповідає розміру. Ми рекомендуємо вам отримати звичайний розмір.</p>
                                    <p>Модель має зріст 178 см і носить 34 розмір.</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="card-infot4" role="tabpanel">
                                <div class="new-card-info-text">
                                    <p>Безкоштовна доставка замовлень на суму понад 600 євро. Для замовлень за межами ЄС мито буде розраховано під час оформлення замовлення.</p>
                                    <p>Додаткову інформацію див. у розділі <a href="#">Доставка та повернення</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="new-card-size-block">
                        ...
                        <div class="new-card-size-list">
                            <a href="#" class="new-card-size-item">
                                34
                            </a>
                            <a href="#" class="new-card-size-item active">
                                36
                            </a>
                            <a href="#" class="new-card-size-item">
                                38
                        ...
                        <div class="new-card-size-btn">
                            <a href="#" class="new-card-size-guide">
                                Розмірна сітка
                            </a>
                        </div>
                    </div>
        ...
        <div class="new-card-info-mob">
            ...
            <div class="new-card-info-price-block">
                <div class="new-card-info-price-old">
                    2000 грн
                </div>
                <div class="new-card-info-price">
                    1500 грн
                </div>
            </div>
            <div class="new-card-btn">
                <a href="#" class="new-card-btn-buy">У Кошик</a>
            </div>
        </div>
    </div>
*/?>

            ...
            <div class="new-card-info-cont">
                <div class="new-card-info-block" data-entity="scu" style="height: 100%;">
                    ...
                    <div class="new-card-info-goods">
                        <div class="new-card-info-name h1four" data-entity="name_card">
                                ...
                                <div class="tab-pane fade" id="card-infot2" role="tabpanel">
                                    <div class="new-card-info-text">
                                        ...
                                        foreach ($arResult['OFFERS'][0]['DISPLAY_PROPERTIES'] as $index => $arProp)
                                        {
                                            ...
                                            if($arProp['CODE'] == 'COLOR_REF' && LANGUAGE_ID == 'ru') $arProp['VALUE'] = $arProp['DISPLAY_VALUE'];
                                            ?>
                                            <p style="margin: 1px 0;" code="<?=$arProp['CODE']?>"><?=$arProp['NAME']?>: <?=is_array($arProp['VALUE']) ? implode(', ',$arProp['VALUE']) : $arProp['VALUE']?></p>
                                            <?
                                        }
                                        ?>
                                    </div>
                    ...
                    <div class="new-card-size-block">
                        ...
                        <div class="new-card-size-btn">
                            <a href="#" class="new-card-size-guide" data-toggle="modal" data-target="#size-popup">

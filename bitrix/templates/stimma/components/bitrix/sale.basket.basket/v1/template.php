...
if (empty($arResult['ERROR_MESSAGE']))
{
    ...
    <script>
        ...
        dataLayer.push({
            event: "view_cart", // подія перегляду корзини
            ecommerce: {
                currency: "UAH", // валюта ціни UAH - гривня
                value: 25.54, // кінцеве значення ціни після знижки помножене на кількість доданих товарів
                items: [
                    <?=implode(',', $productJson)?>
                ]
            }

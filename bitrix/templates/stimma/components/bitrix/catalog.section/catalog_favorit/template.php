			...
			<div class="hot-wrapper-items">
				...
				<div class="items swipeignore mobile-overflow mobile-margin-16 mobile-compact c_<?=count($arResult["ITEMS"]);?>">
					<?if(count($arResult["ITEMS"]) > 1):?>
						...
						<ul class="flex-direction-nav fdn1"><li class="flex-nav-prev"><span class="flex-prev js-click">Previous</span></li><li class="flex-nav-next"><span class="flex-next js-click">Next</span></li></ul>
						</div>
					<?endif;?>

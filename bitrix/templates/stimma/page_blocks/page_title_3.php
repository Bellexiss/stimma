<div class="top-block-wrapper">
    ...
    //if(strpos($APPLICATION->GetCurPage(), '/catalog/') === false && strpos($APPLICATION->GetCurPage(), '/news/') === false)
    if(!$isDetail && strpos($APPLICATION->GetCurPage(), '/news/') === false)
    {
        ?>
            ...
            <?/*<div class="topic">
                <div class="topic__inner">
                    ...
                    <div class="topic__heading">
                        <h1 id="pagetitle th41"><?$APPLICATION->ShowTitle(false)?></h1><?$APPLICATION->ShowViewContent('more_text_title');?>
                    </div>
                </div>
            </div>*/?>

...
function load_mode_scroll(object)
{
...
$(document).on("click", ".order-list-toggler-bg", function () {
  ...
  if ($(this).parent().hasClass("opened")) {
    $(".order-list-mob-bg").slideDown();
  } else{
    $(".order-list-mob-bg").slideUp();
  }
});

$(document).mouseup(function (e) {
    var container = $(".header-city-select-form");
    if (container.has(e.target).length === 0){
        $('.header-city-select-form').removeClass('opened');
    }

    var container = $(".card-info-size-cont");
    if (container.has(e.target).length === 0){
        $('.card-info-size-cont').removeClass('opened');
    }

    var container = $(".header-menu-block");
    if (container.has(e.target).length === 0){
        $('.header-menu-block').removeClass('opened');
    }
});
...
if (!funcDefined("initSelects")) {
  function initSelects(target) {
    ...
    // SELECT STYLING
    if(location.href.indexOf('/vacancies/') == -1)
    {
      $(target)
...
$(document).ready(function () {
  ...
  //ecommerce order
    /*if(typeof arAsproOptions !='undefined' && typeof arAsproOptions["PAGES"]!= 'undefined')
    {
...
$( document ).ready(function() {
    ...
    if ($(".catalog-category-cont").length) {
      if($(window).width() < 767) {
       $('.catalog-category-cont').slick({
          dots: true,
          arrows:false,
          infinite: false,
          slidesToShow: 6,
    ...
    $('.main-googs-list.main-googs-list-order ').slick({
          dots: false,
          arrows:true,
          infinite: true,
          appendArrows:".slider-controls-block .slider-controls",
          slidesToShow: 4,
          slidesToScroll: 1,
          responsive: [
            {
    ...
    $(document).mouseup(function (e) {
    var container = $(".catalog-filter-cont:not(.catalog-filter-cont-opener)");
        if (container.has(e.target).length === 0){
            $('.catalog-filter-cont:not(.catalog-filter-cont-opener)').removeClass("opened")
        }
    });

    $( ".catalog-filter-name" ).on( "click", function() {
      if ($(this).parents('.catalog-filter-cont').hasClass('opened')) {
        $(this).parents('.catalog-filter-cont').removeClass('opened')
      }else{
        $('.catalog-filter-cont').removeClass("opened")
        $(this).parents('.catalog-filter-cont').toggleClass('opened');
    ...
    $( ".new-card-size-guide" ).on( "click", function() {
      //$('.card-info-size-cont').toggleClass("opened")
      //return false;
    });
    ...
    $('.sss-bonus-buy-slider .catalog-item-img-slider').slick('unslick');
    /*$('.sss-bonus-buy-slider .catalog-item-img-slider').slick('slickSetOption', 'draggable', false, true);*/

...
$user = CUser::GetList('','', ['PERSONAL_PHONE' => $phone]);
if($user = $user->Fetch())
{
    $_REQUEST['USER_LOGIN'] = $_POST['USER_LOGIN'] = $user['LOGIN'];
    //setcookie('BITRIX_SM_LOGIN', $user['LOGIN'], time()+60*60*24*30);
}

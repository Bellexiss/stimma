...
if(LANGUAGE_ID == 'ua')
{
    $arResult['NAME'] = $arResult['PROPERTIES']['NAME_UA']['VALUE'];
    $arResult['FIELDS']['PREVIEW_TEXT'] = $arResult['PROPERTIES']['WIDE_TEXT_UA']['~VALUE']['TEXT'];
...
/*if(LANGUAGE_ID == 'ua')
{
    ...
    while($section = $res->Fetch()) {
        ...
        $APPLICATION -> AddChainItem($section['NAME'], 'asd');
    }

    $APPLICATION -> AddChainItem($arResult['NAME'], 'asd');

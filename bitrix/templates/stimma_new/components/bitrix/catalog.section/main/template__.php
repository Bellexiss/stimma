                        ...
                        <div class="catalog-item-block"  data-entity="scu-values">
                            ...
                            <div class="catalog-item-info">
                                <div class="catalog-item-price">
                                    <?
                                    if($item['PROPERTIES']['PROP_BONUS']['VALUE'])
                                        {
                                            ?>
                                            <?=$item['PROPERTIES']['PROP_BONUS']['VALUE']?> <span class="bonus">стімзів</span>
                                    ...
                                    {
                                        ?><div class="catalog-item-price-old cip4"><?=$item['PRICES']['BASE']['PRINT_VALUE']?></div><?
                                    }
                                    ?>
                                </div>
                                <div class="catalog-item-colors cic1" data-code="COLOR_REF">
                                    <?

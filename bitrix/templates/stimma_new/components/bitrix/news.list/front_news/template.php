				...
				<?endif;?>
					...
					<?endif;?>
						<div class="inner-text<?=($bShowSection ? ' with-section' : '');?><?=($bActiveDate ? ' with-date' : '');?><?=($arParams['TITLE_SHOW_FON'] == 'Y' ? ' with-fon' : '');?>">
							...
							<?endif;?>
							<?if($bShowSection):?>
								<div class="section muted font_upper">
                                    <?=LANGUAGE_ID && $arResult['SECTIONS'][$arItem['IBLOCK_SECTION_ID']]['UF_NAME_UA'] ? $arResult['SECTIONS'][$arItem['IBLOCK_SECTION_ID']]['UF_NAME_UA'] : $arResult['SECTIONS'][$arItem['IBLOCK_SECTION_ID']]['NAME'];?>
                                </div>
							<?endif;?>
							...
							<?if($bActiveDate):?>
								<div class="period-block<?=($bShowSection && !$bLineImg ? '' : ' muted');?> <?=($arParams['HALF_BLOCK'] == 'Y' && $indexItem ? 'font_xxs' : 'font_xs');?>">
									...
									<?else:?>
										<span class="date"><?=date('d.m.Y',strtotime($arItem['ACTIVE_FROM']))?></span>
									<?endif;?>
								</div>
							<?endif;?>

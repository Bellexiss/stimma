                        ...
                        <div class="lookbook-wrapper mobile-adaptive <?=($i ? 'lookbook--hidden' : '')?>" data-code="<?=$arSection['ID']?>">
                            ...
                            <?if ($arSection['ITEMS_COUNT'] > 1):?>
                                <div class="flexslider flexslider-init flexslider--absolute">
                                    <ul class="flex-direction-nav fdn3">
                            ...
                            <div class="swipeignore mobile-overflow c_<?=count($arSection['ITEMS']);?> mobile-margin-16 mobile-compact">
                                <?foreach($arSection['ITEMS'] as $j => $arItem):?>
                                    <?
                                if(LANGUAGE_ID == 'ua' && $arItem['PROPERTIES']['NAME_UA']['VALUE'])
                                {
                                    $arItem['NAME'] = $arItem['PROPERTIES']['NAME_UA']['VALUE'];
                                    $arItem['PREVIEW_TEXT'] = $arItem['PROPERTIES']['DETAIL_TEXT_UA']['VALUE']['TEXT'];
                                }
                                                        ...
                                                        <div class="col-md-6 col-xxs-12">
                                                            <div class="scrollbars scrollblock to-text lookbook--mh-600">
                                                                <div class="lookbook__info lookbook--pl-49 lookbook--pt-49 lookbook--pb-49 lookbook--pr-49">
                                                                    <div class="lookbook__info-wrapper liw2">
                                                                        ...
                                                                        <?if($bShowDopText):?>
                                                                            <div class="lookbook__info-text-more">
                                                                                ...
                                                                                <?endif?>
                                                                                <?
                                                                                if($arItem['PROPERTIES']['LINK_GOODS']['VALUE'])
                                                                                {
                                                                                    ?>
                                                                                <div class="lookbook__info-properties properties list">
                                                                                    <div class="properties__container properties">
                                                                                    <?
                                                                                    foreach ($arItem['PROPERTIES']['LINK_GOODS']['VALUE'] as $index => $id)
                                                                                    {
                                                                                        $pProduct = CIBlockElement::GetByID($id) -> GetNext();
                                                                                        $sProduct = CIBlockElement::GetByID($id) -> GetNextElement();

                                                                                        $fields = $sProduct -> GetFields();
                                                                                        $props = $sProduct -> GetProperties();
                                                                                        ?>
                                                                                        <div class="properties__item lookbook__info-properties--mt-5 font_xs">
                                                                                            <div class="properties__title muted properties__item--inline">
                                                                                                <a class="obraz_link" href="<?=$pProduct['DETAIL_PAGE_URL']?>">
                                                                                                    <?=LANGUAGE_ID == 'ua' && $props['NAME_UA']['VALUE'] ? $props['NAME_UA']['VALUE'] : $fields['NAME']?>
                                                                                                </a>
                                                                                            </div>
                                                                                        </div>
                                                                                        <?

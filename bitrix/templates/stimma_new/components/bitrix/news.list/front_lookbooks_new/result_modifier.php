...
<?if ($arResult['ITEMS']) {
    ...
    if ($arSectionsID) {
        ...
        $arSectionsItem = CMaxCache::CIBLockSection_GetList(
            ...
            false,
            ['ID', 'IBLOCK_ID', 'DEPTH_LEVEL', 'LEFT_MARGIN', 'RIGHT_MARGIN', 'NAME', 'SORT', 'UF_*']
        );
         if ($arSectionsItem) {
             ...
             if ($arSectionsDepth) {
                foreach ($arSectionsDepth as $arSection) {
                    $arSectionTmp = CMaxCache::CIBLockSection_GetList(
                        ...
                        false,
                        ['ID', 'IBLOCK_ID', 'DEPTH_LEVEL', 'NAME', 'SORT','UF_*']
                    );
                    if ($arSectionTmp) {
                ...
                foreach ($arSectionsRoot as $arSection) {
                    ...
                    if ($arSectionsByRoot[$arSection['ID']]) {
                        ...
                        foreach ($arSectionsByRoot[$arSection['ID']] as $key => $id) {
                            ...
                            $arSectionPath[] = LANGUAGE_ID == 'ua' ?  $arSectionsDepth[$id]['UF_NAME_UA'] : $arSectionsDepth[$id]['NAME'];

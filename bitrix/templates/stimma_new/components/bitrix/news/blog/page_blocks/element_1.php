<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SET_TITLE" => LANGUAGE_ID=='ua' ? 'N' : 'Y', //$arParams["SET_TITLE"],
		"SET_STATUS_404" => $arParams["SET_STATUS_404"],
		"INCLUDE_IBLOCK_INTO_CHAIN" => $arParams["INCLUDE_IBLOCK_INTO_CHAIN"],
		"ADD_SECTIONS_CHAIN" => LANGUAGE_ID=='ua' ? 'N' : 'Y', //$arParams["ADD_SECTIONS_CHAIN"],
		"ADD_ELEMENT_CHAIN" => LANGUAGE_ID=='ua' ? 'N' : 'Y',//$arParams["ADD_ELEMENT_CHAIN"],

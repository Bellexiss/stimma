                ...
                //if(isset($_GET['showme']))
                {
                    ...
                    <div class="accordion-item" data-code="SOZRTING" data-role="bx_filter_block">
                        <div class="accordion-header">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#filter-block0" aria-expanded="true">Сортування</button>
                        </div>
                ...
                */
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem)
                {
                    ...
                    <div class="accordion-item" data-code="<?=$arItem['CODE']?>" data-role="bx_filter_block">
                            <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#filter-block<?=$kNumber?>" aria-expanded="true" ><?=LANGUAGE_ID == 'ua' && $arItem['FILTER_HINT'] ? $arItem['FILTER_HINT'] :$arItem['NAME']?></button>
                            </div>
                        ...
                        if(isset($arItem["PRICE"]) || $key == 'MINIMUM_PRICE'):
                            ...
                            ?>
                                <div class="accordion-item" data-role="bx_filter_block">
                                    <div class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#filter-block-price" aria-expanded="true"> 
                                            <span><?=LANGUAGE_ID == 'ua' ? 'Ціна' : 'Цена'?></span>

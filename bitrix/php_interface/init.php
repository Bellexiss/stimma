            ...
            <div class="basket-header-list-cont">
                <div class="basket-header-list">
                    ...
                    foreach($basket['ITEMS'] as $index => $arItem)
                    {
                        ...
                        if(($arItem['PRODUCT_ID'] == 47170 || $arItem['PRODUCT_ID'] == 47171) && ($isJulyAction || SEP_SHORT))
                                ...
                                <div class="basket-header-info">
                                    <div class="basket-header-prop">
                                        ...
                                        <div class="basket-header-price-block">
                                            <?
                                            if(isset($withStims['ID']) && $withStims['UF_STIMS'])
                                            {
...
function createRegisterCoupon($email, $json=false)
{
    ...
    else
    {
        ...
        //$code = md5($email.time());
        //$DB->Query('insert into subscribers (UF_EMAIL,UF_DATE,UF_DATE_X,UF_COUPON) values (\''.$email.'\',\''.$date.'\',\''.$dateX.'\', \''.$code.'\')');
...
Что бы получить ее, пожалуйста, проверь почту и подтверди свой e-mail.';
        ...
        if ($result->isSuccess())
        {
            ...
            $DB->Query('insert into subscribers (UF_EMAIL,UF_DATE,UF_DATE_X,UF_COUPON) values (\''.$email.'\',\''.$date.'\',\''.$dateX.'\', \''.$codeCoupon.'\')');

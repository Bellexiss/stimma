    ...
    {?>
        ...
        <div class="wrapper">
        	<div class="catalog-page ">
                ...
                <!--  catalog-page-margin-0 Забирає відспути і все як в дизайні -->

        		<div class="catalog-grid catalog-grid-new catalog-page-margin-0">
                    ...
                    <div class="catalog-grid catalog-grid-new-incide">
                        <div class="catalog-grid-item">
                            <div class="catalog-item">
                            <div class="catalog-item-top">
                                <div class="catalog-item-img">
                    ...
                    <div class="catalog-new-banner-block">
                        <div class="catalog-new-banner-title">
                            New collection
                        </div>

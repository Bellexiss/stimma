...
$APPLICATION->SetPageProperty("title", "Розпродаж від 199 грн. Купити Розпродаж від ТМ «Стимма» | Харків, Київ, Дніпро, Одеса, Львів");
	...
	if(isset($_GET['newstimma'])  || NEW_STIMMA)
    {
        ...
        if($APPLICATION -> GetCurPage() == '/catalog/lieta/' || $APPLICATION -> GetCurPage() == '/ru/catalog/lieta/')
            $isH1=true;
        $bIndex = (strpos($_SERVER['HTTP_USER_AGENT'], 'Lighthouse') !== false) || isset($_GET['google']);
        global $MAX_SMART_FILTER;

        //$tpl = $USER->IsAdmin() || isset($_GET['pu']) ? 'new' : '.default';
        $tpl = 'new';
                                ...
                                <div class="catalog-item-details">
                                    <div class="catalog-item-price-block">
                                        <div class="catalog-item-price">
                                            3699 <span class="bonus">стімзів</span>
                        ...
                        <div class="accordion" >
                          <div class="accordion-item">
                            ...
                            <div id="panels1" class="accordion-collapse collapse">
                              <div class="accordion-body">
                                Текст випадашки Текст випадашкиТекст випадашки Текст випадашкиТекст випадашкиТекст випадашки Текст випадашкиТекст випадашки Текст випадашки Текст випадашки
                              </div>
                            </div>
                          </div>
                          <div class="accordion-item">

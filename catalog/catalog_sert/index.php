                    ...
                    <div class="card-content">
                        <div class="card-img-cont">
                            <div class="card-img-solo">
                                <img src="/bitrix/templates/stimma_new/images/imgnew/sertificate.png">
                            </div>
                        </div>
                        <div class="card-info-block">
                            <div class="card-name-block">
                                <div class="card-name">
                                    Подарунковий сертифікат STIMMA
                                </div>
                            </div>
                                ...
                                <form>
                                    <div class="card-form">
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Ім’я та прізвище відправника*">
                                        </div>
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Телефон відправника*">
                                        </div>
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Ім’я та прізвище отримувача*">
                                        </div>
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Пошта отримувача*">
                                        </div>
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Дата відправлення сертифікату*">
                                        </div>
                                        <div class="form-block">
                                            <input type="text" name="" value="" class="form-control" placeholder="Ваші побажання">
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#card-accord11" aria-expanded="false" aria-controls="card-accord11">
                                                Умови використання онлайн-сертифікату:
                                            </button>
                                        </div>
                                        <div id="card-accord11" class="accordion-collapse collapse" data-bs-parent="#card-accord">
                                            <div class="accordion-body">
                                                <p>
                                                    Термін дії сертифіката 3 місяці з дати отримання листа.<br> Якщо сума чека перевищує номінал сертифіката — необхідно доплатити різницю. Доплату можна здійснити на сайті або накладеним платежем при отриманні замовлення. Якщо сума чека менше номіналу — залишок зберігається на балансі.
                                                </p>
                                                <p>
                                                    Сертифікат не підлягає поверненню та обміну на грошові кошти.<br> Сертифікатом можна скористатися лише на сайті stimma.com.ua та в <a href="#">офіційному інстаграмі</a>.
                                                </p>
                                                <p>
                                                    Сертифікат діє на всі позиції представлені на сайті за умови наявності товару.
                                                </p>
                                            </div>
                                        </div>
                                    </div>

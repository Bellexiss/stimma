...
Bitrix\Main\Diag\Debug::writeToFile($headers, "start get order " , '/api/bumbum.txt');
Bitrix\Main\Diag\Debug::writeToFile($apiKey, "start get order " , '/api/bumbum.txt');
...
$url = 'http://195.201.245.102:22022/sklad/hs/list/orders/v1/create';
